...
const char AutoConnect::_PAGE_STAT[] PROGMEM = {
    ...
    "Connected: {{ESTAB_SSID}}"
    "</div>"
    "<ul class=\"list-group list-group-flush \">"
    "<li class=\"list-group-item\">"
    "<a href=\"" AUTOCONNECT_URI_CONFIG "\" class=\"btn btn-primary\">Connect to network</a>"
    "</li>"
    "<li class=\"list-group-item\">"
    "<a href=\"" AUTOCONNECT_URI_OPEN "\" class=\"btn btn-primary\">View past network(S)</a>"
    "</li>"
    "<li class=\"list-group-item\">"
    "<a href=\"" AUTOCONNECT_URI_RESET "\" class=\"btn btn-primary\">Reboot device</a>"
    "</li>"
    "</ul>"
    "</div>"
    "</div>"
